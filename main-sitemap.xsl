			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Ubicaciones del mapa del sitio - Defitero</title>
					</xsl:when>
					<xsl:otherwise>
						<title>Mapa del sitio XML - Defitero</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://defitero.com/sitemap_index.xml">&#8592; Índice del mapa del sitio</a>							</p>
